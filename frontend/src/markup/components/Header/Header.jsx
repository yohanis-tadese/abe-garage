          ...
          <div className="auto-container">
            <div className="inner-container">
              <div className="left-column">
                {isLogged ? (
                  <div className="text"> Well come to our system !! </div>
                ) : (
                  <>
                    <div className="text">
              ...
              <div className="right-column pr-lg-5">
                {isLogged ? (
                  ...
                  <div className="phone-number">
                    Schedule Appointment: <span> 0984751233 </span>{" "}
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="inner-container">
              ...
              <div className="right-column">
                <div className="nav-outer">
                  ...
                  <nav className="main-menu navbar-expand-sm navbar-light">
                    <div
